...
with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
    ...
    with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic_rh_v:
        with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic_h_rv:
            with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic_rh_rv:
                ...
                for action in actions:
                    ...
                    no_sequences_h_rv = int(no_sequences) + no_sequences_rh_v #sequencias das amostras invertidas na horizontal
                    no_sequences_rh_rv = int(no_sequences) + no_sequences_h_rv #sequencias das amostras invertidas na horizontal
                    ...
                    for sequence in range(int(nro_amostra_inicial),(int(nro_amostra_inicial) + int(no_sequences))):
                        ...
                        for frame_num in range(sequence_length):
                            ...
                            image_h_rv, results_h_rv = md.mediapipe_detection(cv2.flip(frame, 0), holistic_h_rv) #amostras invertidas na vertical
                            image_rh_rv, results_rh_rv = md.mediapipe_detection(cv2.flip(frame, -1), holistic_rh_rv) #amostras invertidas nos dois eixos
                            ...
                            keypoints_rh_rv = ek.extract_keypoints(results_rh_rv) #amostras invertidas nos dois eixos
                            ...
                            npy_path_rh_rv = os.path.join(DATA_PATH, action, str(no_sequences_rh_rv), str(frame_num)) #amostras invertidas nos dois eixos
                            ...
                            np.save(npy_path_rh_rv, keypoints_rh_rv) #amostras invertidas nos dois eixos
                        ...
                        no_sequences_rh_rv = no_sequences_rh_rv + 1  # amostras invertidas nos dois eixos
